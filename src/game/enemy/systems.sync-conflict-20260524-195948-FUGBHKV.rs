...
pub fn update_enemy_direction(
    ...
    for (transform, mut enemy) in enemy_query.iter_mut() {
        ...
        if direction_changed {
            // Play Sound Effect
            let sound_effect_1 = String::from("audio/pluck_001.ogg");
            let sound_effect_2 = String::from("audio/pluck_002.ogg");
            ...
            commands.spawn((
                AudioPlayer::new(asset_server.load(sound_effect)),
...
pub fn move_direct_confine_enemies(
    mut commands: Commands,
    ...
    for (mut transform, mut enemy) in enemy_query.iter_mut() {
        ...
        let direction = Vec3::new(enemy.direction.x, enemy.direction.y, 0.0);
        transform.translation = translation + direction * ENEMY_SPEED * time.delta_secs();
